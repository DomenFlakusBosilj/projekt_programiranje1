...
frontpage_url = 'https://www.nepremicnine.net/oglasi-prodaja/slovenija/'
...
#funkcija ki se zapelje po vseh straneh
for stevilka in range(2,668):
    url = (
        f'https://www.nepremicnine.net/oglasi-prodaja/slovenija/{stevilka}/'             #f dela kot format
    )
    print(f'zajemam stran {url}...')
